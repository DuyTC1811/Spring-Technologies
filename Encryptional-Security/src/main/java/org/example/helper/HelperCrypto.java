...
public class HelperCrypto {
    ...
    public static Map<String, String> encryptAndSign(String jsonPayload,
                                                     PublicKey bankRsaPublicKey,
                                                     PrivateKey clientRsaPrivateKey) throws Exception {
    ...
    public static String verifyAndDecrypt(Map<String, String> req, PrivateKey bankRsaPrivateKey, PublicKey clientRsaPublicKey) throws Exception {
    ...
    public static byte[] aesGcmEncrypt(SecretKey key, byte[] iv, byte[] plaintext, byte[] aad) throws Exception {
    ...
    public static byte[] aesGcmDecrypt(SecretKey key, byte[] iv, byte[] ciphertext, byte[] aad) throws Exception {
        Cipher cipher = Cipher.getInstance("AES/GCM/NoPadding");
        GCMParameterSpec gcm = new GCMParameterSpec(128, iv);
    ...
    public static byte[] rsaOaepDecrypt(byte[] enc, PrivateKey priv) throws Exception {
        Cipher c = Cipher.getInstance("RSA/ECB/OAEPWithSHA-256AndMGF1Padding");
        OAEPParameterSpec spec = new OAEPParameterSpec("SHA-256", "MGF1", MGF1ParameterSpec.SHA256, PSource.PSpecified.DEFAULT);
    ...
    public static byte[] rsaSignSha256(byte[] data, PrivateKey priv) throws Exception {
