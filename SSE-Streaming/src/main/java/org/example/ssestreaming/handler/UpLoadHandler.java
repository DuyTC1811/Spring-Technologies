...
import static org.example.ssestreaming.enums.UploadState.VALID;
...
public class UpLoadHandler {
    ...
    public void handlerUpload(String uploadId, MultipartFile file) {
        try {
            ...
            sseProgressStore.save(new UploadStatus(uploadId, 95, VALID, "Hóa đơn hợp lệ, chuẩn bị hoàn tất"));
            Thread.sleep(3_000L);
